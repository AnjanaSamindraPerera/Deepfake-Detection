...
model.load_state_dict(torch.load("/hdd/2017CS128/Research/Deepfake-Detection/output/xception_RESRGAN_LAST/best.pkl"))
...
plt.title(f'Xception Model with RESRGAN ROC curve; AUC: {AUROC}');
plt.savefig('Xception_AUC_RESRGAN.png')   