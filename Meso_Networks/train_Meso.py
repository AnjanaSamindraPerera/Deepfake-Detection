...
def main():
	...
	torch.save(model.module.state_dict(), os.path.join(output_path, "best.pkl")) #for parallel
	#torch.save(model.state_dict(), os.path.join(output_path, "best.pkl")) #for one cuda
...
if __name__ == '__main__':
	...
	parse.add_argument('--train_path', '-tp' , type=str, default = '/hdd/2017CS128/Research/FFc40-RESRGAN/train')
	parse.add_argument('--val_path', '-vp' , type=str, default = '/hdd/2017CS128/Research/FFc40-RESRGAN/validation')
