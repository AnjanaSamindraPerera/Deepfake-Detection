...
test_dataset = torchvision.datasets.ImageFolder("/hdd/2017CS128/Research/FFc40_VDSR2/test", transform=mesonet_data_transforms['test'])
...
model.load_state_dict(torch.load("/hdd/2017CS128/Research/MesoNet-Pytorch/output/Mesonet_Inception-VDSR_FF/29_Mesonet_Inception.pkl"))
...
plt.title(f'MesoInception Model with VDSR ROC curve; AUC: {AUROC}');
plt.savefig('MesoInception_AUC_VDSR2.png')