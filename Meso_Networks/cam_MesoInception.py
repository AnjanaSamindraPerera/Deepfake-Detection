...
model.load_state_dict(torch.load("/hdd/2017CS128/Research/MesoNet-Pytorch/output/Mesonet_Inception_RESRGAN3/3_Mesonet_Inception.pkl"))
print(model)
#model = resnet18(pretrained=True).eval()
cam_extractor = SmoothGradCAMpp(model,'conv2')
# Get your input
