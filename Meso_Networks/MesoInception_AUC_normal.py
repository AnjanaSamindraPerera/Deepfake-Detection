...
test_dataset = torchvision.datasets.ImageFolder("/hdd/2017CS128/Research/FFc40-split2/test", transform=mesonet_data_transforms['test'])
...
model.load_state_dict(torch.load("/hdd/2017CS128/Research/MesoNet-Pytorch/output/Mesonet_Inception-normal_FF/1_Mesonet_Inception.pkl"))
...
plt.title(f'MesoInception Model without SR ROC curve; AUC: {AUROC}');
plt.savefig('MesoInception_AUC_normal2.png')