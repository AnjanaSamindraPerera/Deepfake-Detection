...
if __name__ == '__main__':
	...
	parse.add_argument('--name', '-n', type=str, default='Mesonet_Inception')
	parse.add_argument('--train_path', '-tp' , type=str, default = '/hdd/2017CS128/Research/FFc40-RESRGAN3/train')
	parse.add_argument('--val_path', '-vp' , type=str, default = '/hdd/2017CS128/Research/FFc40-RESRGAN3/validation')
	parse.add_argument('--batch_size', '-bz', type=int, default=32)
	parse.add_argument('--epoches', '-e', type=int, default='30')
	parse.add_argument('--model_name', '-mn', type=str, default='Mesonet_Inception.pkl')
	parse.add_argument('--continue_train', type=bool, default=False)
	parse.add_argument('--model_path', '-mp', type=str, default='./output/Mesonet_Inception/best.pkl')
	main()