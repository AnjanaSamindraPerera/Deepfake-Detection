...
#Creat the model
model = Meso4()
model.load_state_dict(torch.load("/hdd/2017CS128/Research/MesoNet-Pytorch/output/Mesonet-vdsr_FF/best.pkl"))
...
plt.title(f'Meso-4 Model with VDSR ROC curve; AUC: {AUROC}');
plt.savefig('MesoNet_AUC_VDSR2.png')