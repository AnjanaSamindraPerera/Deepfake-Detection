...
#Creat the model
model = Meso4()
model.load_state_dict(torch.load("/hdd/2017CS128/Research/MesoNet-Pytorch/output/Mesonet-SRGAN_FF/29_meso4.pkl"))
...
plt.title(f'Meso-4 Model without SR ROC curve; AUC: {AUROC}');
plt.savefig('MesoNet_AUC_normal2.png')