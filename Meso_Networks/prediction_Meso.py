...
#Creat the model
model = Meso4()
model.load_state_dict(torch.load("/hdd/2017CS128/Research/MesoNet-Pytorch/output/Mesonet_RESRGAN_FF/24_meso4.pkl"))
...
print('\n')
print("Testing accuracy with Meso4:",accuracy_score(y_true_list, y_pred_list))
