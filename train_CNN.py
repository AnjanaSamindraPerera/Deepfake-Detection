...
if __name__ == '__main__':
	...
	parse.add_argument('--train_list', '-tl' , type=str, default = '/hdd/2017CS128/Research/FFc40-RESRGAN3/train')
	parse.add_argument('--val_list', '-vl' , type=str, default = '/hdd/2017CS128/Research/FFc40-RESRGAN3/validation')
	...
	parse.add_argument('--model_path', '-mp', type=str, default='/hdd/2017CS128/Research/Deepfake-Detection/output/DFD-all/best.pkl')
	main()