...
test_dataset = torchvision.datasets.ImageFolder("/hdd/2017CS128/Research/FFc40_VDSR2/test", transform=xception_default_data_transforms['test'])
...
model.load_state_dict(torch.load("/hdd/2017CS128/Research/Deepfake-Detection/output/xception-vdsr2_30/best.pkl"))
...
plt.title(f'Xception Model with VDSR ROC curve; AUC: {AUROC}');
plt.savefig('Xception_AUC_VDSR2.png')   